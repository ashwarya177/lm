        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="userprofile.php"><span class="glyphicon glyphicon-home"
                         aria-hidden="true"></span>&nbsp; Dashboard</a></li>
                    <li><a href="#apply"><span class="glyphicon glyphicon-pencil"
                         aria-hidden="true"></span>&nbsp; Apply for Leave</a></li> 
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                         ...
                         aria-hidden="true"></span>&nbsp; <?php  echo ($r["name"]); ?><span class="caret"></span></a>
...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="tab-content">
                ...
                <p>Number of Medical Leaves remaining for you are <strong><?php echo $m; if($q1 == -1) { echo ". $p";} ?></strong></p>
                </div>
                ...
                <p>Number of Restricted Holidays remaining for you are <strong><?php echo $rest; if($q2 == -1) { echo ". $p";} ?></strong></p>
                </div>
                ...
                <p>Number of Casual Leaves remaining for you are <strong><?php echo $c; if($q3 == -1) { echo ". $p";}?></strong></p>
                </div>
                ...
                <p>Number of Study leaves remaining for you are <strong><?php echo $s; if($q4 == -1) { echo ". $p";}?></strong></p>
                </div>
                ...
                <p>Number of Earned leaves remaining for you are <strong><?php  echo $el; if($q5 == -1) { echo ". $p";} ?></strong></p>
                </div>
            </div>
         </div>   
    </div>
...
include 'config.php';
    ...
    $sql1 = "INSERT INTO leaves Values('$lid', '$un', '$name', '$num', '$desig', '$branch', '$type', $days, '$sdate', '$edate', '$reason', '$sname', 0, 0 )";
