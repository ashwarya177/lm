...
if($ba == 3)
{    
                    echo "<a href=alstatus.php><span class='glyphicon glyphicon-bookmark'
                         aria-hidden='true'></span>&nbsp; Applied Leaves Status</a>";
}
?></li> 
                    <li><a href="viewall.php" ><span class='glyphicon glyphicon-envelope'
    ...
    <div class="col-xs-12 col-sm-6 col-sm-offset-3">    
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    <td><strong>Sanctioned By HOD:</strong></td>
                    <td>Yes</td>
                </tr>
            </table>
        </div>
...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-sm-offset-3">
        <form class="form-horizontal" role="form" <?php echo "action=sanction.php?ba=$ba"; ?> method="post">
...
if($st==1)
{   
    $sql3 = mysqli_query($con, "SELECT * from users Where uname='$uname'");
    ...
    if($type==1)
    {
        ...
        $sql4 = mysqli_query($con, "UPDATE users SET medical=$nm Where uname='$uname'");
    }
    else if($type==2)
    {
        $rest = $row["restricted"];
        ...
        $sql4 = mysqli_query($con, "UPDATE users SET restricted=$nrest Where uname='$uname'");
    }
    else if($type==4)
    {
        $s = $row["study"];
        ...
        $sql4 = mysqli_query($con, "UPDATE users SET study=$ns Where uname='$uname'");
    }
    else if($type==5)
    {
        $el = $row["earned"];
        ...
        $sql4 = mysqli_query($con, "UPDATE users SET earned=$nel Where uname='$uname'");
    }
    else
    {}
}
    ...
    if($ba == 1)
    {
        $sql2 = "UPDATE leaves SET vsadmin=$st Where lid='$lid'";
    }
    if($ba == 2)
    {
        $sql2 = "UPDATE leaves SET vsadmin=$st, vhod=2 Where lid='$lid'";
    }
